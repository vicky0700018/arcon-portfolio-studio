...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Prospera Arcon LLP Pune | Digital Portfolio" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Prospera Arcon LLP Pune" },
      { property: "og:title", content: "Prospera Arcon LLP Pune | Digital Portfolio" },
      {
